              ...
              <tr v-for="(item, i) in items" :key="item.id">
                <td>
                  <span v-show="!item.edit">
                    <v-btn icon="mdi-check-circle" variant="text" color="green" @click="completeItem(item.id)"></v-btn>
                    {{ item.name }}
                  </span>
                  <v-text-field
                    v-show="item.edit"
...
const { addItem, editItem, delItem, cancelEditItem, confirmEditItem, delFinishedItem, completeItem } = list
